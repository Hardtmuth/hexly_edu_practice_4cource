...
export const EditModal = ({ isOpen, onClose, partner }) => {
  ...
  console.log('[EditModal] partner data:', partner)
  ...
  const handleSubmit = (e) => {
    ...
    console.log('[EditModal Form] edit partner data:', payload);
    dispatch(editPartner({ partnerId: partner.partner_id, data: payload }))
    onClose()
  }
